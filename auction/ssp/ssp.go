...
//		}
//
//		idx := server.Find(SSPData, func(value interface{}) bool {
//
...
//		}
//
//		country := server.GetCountry(r.FormValue("ip"))
//
//		data := dsp.ReqData{
//			IP:      r.FormValue("ip"),
//			UA:      r.FormValue("ua"),
...
//
//			var link = ""
//			link = server.Encrypt(string(jsonLink), config.Config["Crypto"].(string))
